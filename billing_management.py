...
class Bill_App:
    def _init_(self,root):
        ...
        lbl_color = 'white'
        #Title of App
        title = Label(self.root,text = "Billing Software System",bd = 12,relief = GROOVE,fg = fg_color,bg = bg_color,font=("times new roman",30,"bold"),pady = 3).pack(fill = X)
